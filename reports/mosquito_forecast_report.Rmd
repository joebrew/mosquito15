...
As predicted, the number of weekly trapped mosquitoes has begun to rise.  Recent precipitation suggests a continued rise in the mosquito population, with the potential for a sharp uptick mid-month.
...
Numbers so far this summer have been relatively low.  
...
Over the next two weeks, we predict the mosquito population to grow slightly, with the greatest growth ocurring in the north and east of the county.
...
temp <- temp[which(temp$date %in% as.Date(c('2015-09-07', '2015-09-12', '2015-09-19'))),] ##############!!!!!!!!!!!!!!!!!!

...
Numbers so far this summer have been relatively low compared to previous summers.  
...
Vectors of diseases of concern appear relatively evenly distributed throughout the county. In recent weeks, the number of mosquitoes capable of carrying SLEV has increased substantially.
...
temp <- temp[which(temp$date %in% as.Date(c('2015-10-01', '2015-10-04', '2015-10-07'))),] ##############!!!!!!!!!!!!!!!!!!

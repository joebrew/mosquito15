...
Our model predicted high but flat-lining levels through the end of September and beginning of October.  However, in reality, the increasing trend from mid-September continued, with the most recent trapping showing more mosquitoes than at any other point this year.  Weather conditions suggest that we have already reached the peak, and that the number of moquitoes will begin declining. 
...
temp <- temp[which(temp$date %in% as.Date(c('2015-10-10', '2015-10-14', '2015-10-18'))),] ##############!!!!!!!!!!!!!!!!!!

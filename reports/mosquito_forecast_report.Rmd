...
The number of mosquitoes rose in July, albeit slightly more gradually than predicted.  Recent precipitation suggests a continued rise in the mosquito population through mid-August, with a sharper rise through the end of the month.
...
Over the next two weeks, we predict the mosquito population to grow slightly, with the greatest growth ocurring in the south of the county (towards Micanopy) and east (Hawthrone area).
...
temp <- left_join(x = left, y = right)
temp$mosquitoes <- temp$predicted
temp <- temp[which(temp$date <= '2015-08-20'),]
temp <- temp %>%

...
As predicted, the late September spike in mosquitoes has subsided.  Our model predicts a continued decline down to low-normal levels throughout the rest of October.
...
temp <- temp[which(temp$date %in% as.Date(c('2015-10-18', '2015-10-24', '2015-10-28'))),] ##############!!!!!!!!!!!!!!!!!!
